...
var login_register_main = document.querySelector(".login_register_main");

sign_up_btn.addEventListener("click", () => {
  login_register_main.classList.add("sign-up-mode");
});

sign_in_btn.addEventListener("click", () => {
  login_register_main.classList.remove("sign-up-mode");
});
...
var toggleReg = document.querySelector("#toggleReg");
var pass = document.querySelector("#id_reg");
