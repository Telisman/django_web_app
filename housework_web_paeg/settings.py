"""
Django settings for housework_web_paeg project.
...
SECRET_KEY = 'django-insecure-xh5%i78)9pfnpa_!ua((gd(ow@iixua1&1de8m)mngh(ipq55t'
...
ROOT_URLCONF = 'housework_web_paeg.urls'
...
WSGI_APPLICATION = 'housework_web_paeg.wsgi.application'
